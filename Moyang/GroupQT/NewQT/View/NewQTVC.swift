...
class NewQTVC: UIViewController, VCType, UITextFieldDelegate {
...
extension NewQTVC: UICollectionViewDelegateFlowLayout {
...
extension NewQTVC: UICollectionViewDataSource {
